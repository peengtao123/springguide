 ...
 * @version $Revision: 1031 $ $Date: 2009-09-12 17:13:43 +0200 (sab, 12 set
 * 2009) $
...
public abstract class AbstractTableMetaData implements ITableMetaData {
     ...
     * {@link Columns#getColumns(String[], Column[])}
     */
     ...
     * Uses method {@link ITableMetaData#getColumns()} to retrieve all available
     * columns.
     *
     ...
     * @return A map having the key value pair [columnName,
     * columnIndexInInputArray]
     */
     ...
     * @param metaData The {@link java.sql.DatabaseMetaData} needed to get the
     * DB product name of the connection RDBMS.
     * @return A validation message if there is a potential problem or
     * <code>null</code> if everything is fine.
